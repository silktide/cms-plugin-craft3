...
/**
 * Silktide Craft en Translation
 *
 * Returns an array with the string to be translated (as passed to `Craft::t('craft-silktide', '...')`) as
...
return [
    ...
    'Failed to notify Silktide - exception type {exception} message: {message}' => 'Failed to notify Silktide - exception type {exception} message: {message}',
    'Notified Silktide and received a {status} code back with {body}' => 'Notified Silktide and received a {status} code back with {body}',
    'Failed to notify Silktide - HTTP request failed with status {status} and body {body}' => 'Failed to notify Silktide - HTTP request failed with status {status} and body {body}'
];
